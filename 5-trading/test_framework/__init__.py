# Trading problems test framework
import json
...
def load_test_cases(test_file: str) -> list[dict]:
    """Load test cases from a JSON file in trading test_data."""
...
def get_test_data_path(filename: str) -> Path:
    """Get path to a file in trading test_data directory."""
...
__all__ = ['run_tests', 'load_test_cases', 'get_test_data_path']
